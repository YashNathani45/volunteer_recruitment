...
//           navigate('/user_dashboard'); // Redirect to user_dashboard
//         } else {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
      ...
      <form className="max-w-sm w-full mx-auto p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg" onSubmit={handleLoginSubmit}>
        <div className="space-y-6">
          <h5 className="text-2xl font-bold text-gray-900 dark:text-white text-center">Sign in to our platform</h5>
          <div>
          ...
          <button type="submit" className="w-full py-2.5 bg-blue-600 text-white font-medium rounded-lg text-sm hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Login to your account</button>
